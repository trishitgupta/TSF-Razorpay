...
const disHome = () => {
  ...
  <div className="content">
    <div className="info">
      <h2>
        Doing Nothing is not <br />
        <span>an option of our life !</span>
      </h2>
      <p>
      ...
      <a href="https://rzp.io/l/gD20V0Gfe" target="_self" className="info-btn">
        Donate Now
      </a>
    </div>
  </div>
  <div className="media-icons">
    ...
    <a href="https://www.instagram.com/trishit.gupta2610/" target="_blank">
